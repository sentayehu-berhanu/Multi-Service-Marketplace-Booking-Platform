    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-secondary)' }}>
      ...
      <aside className="glass-panel" style={{ width: '250px', borderRight: 'var(--glass-border)', borderRadius: 0, padding: '2rem 1.5rem', display: 'flex', flexDirection: 'column' }}>
        ...
        <nav style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          ) : business?.category?.slug === 'cleaning' ? (
            <Link to="/business-dashboard/cleaning-services" className="hover-scale" style={{ padding: '10px 15px', borderRadius: '10px', color: 'var(--text-secondary)' }}>
              🧹 Cleaning Services
            </Link>
          ...
          ) : business?.category?.slug === 'healthcare' ? (
            <Link to="/business-dashboard/healthcare-services" className="hover-scale" style={{ padding: '10px 15px', borderRadius: '10px', color: 'var(--text-secondary)' }}>
              🩺 Health Services
            </Link>
          ) : business?.category?.slug === 'spa' ? (
          ...
          ) : business?.category?.slug === 'transportation' ? (
